 ...
 * LED to pin 13
 ...
 put a 110 ohm resistance in series  with the thermistor, the side of 110 resistance to 5V
 the side of the thermistor  to GND and the point where the thermistor and the resistance meet
 to analog input  A0
...
void loop() {
  ...
  Serial.println(R);// send the temperature  in using serial
  ...
  // in the both  cases there will be a delay of 1s between sending the temperature to the computer
  // and display in in the lcd
 }
